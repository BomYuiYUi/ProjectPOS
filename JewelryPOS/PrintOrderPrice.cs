...
{
    public partial class PrintOrderPrice : Form
    {
        public PrintOrderPrice()
        {
            InitializeComponent();
        }

        private void PrintOrderPrice_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'DataSetOrder.OrdersPrice' table. You can move, or remove it, as needed.
            //this.OrdersPriceTableAdapter.Fill(this.DataSetOrder.OrdersPrice);
        ...
        private void buttonPrint_Click(object sender, EventArgs e)
        {
            ...
            this.OrdersPriceTableAdapter.Fill(this.DataSetOrder.OrdersPrice,b,c);
            this.reportViewer1.RefreshReport();
